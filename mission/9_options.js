class Options extends GameEngine {
    constructor() {
        super()
        this.buttons = []
        this.buttons[0] = { rect: new Rect(0,0,0,0), label: 'Back', bg: {r:127,g:127,b:127}, fg: {r:255,g:255,b:255}, cb: ()=>{ s = 1 } }
